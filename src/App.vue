...
export default {
  ...
  data(){
    return{
      ...
      accountbzj:0,
      // 修改商品 0.01手盈利1u的浮动价格
      product:[{id:1,title:"XAUUSD",bzj:0.96,profit:1},{id:2,title:"USOIL",bzj:4.5,profit:0.1},{id:3,title:"DXYM",bzj:0.53,profit:0.1},{id:4,title:"AUDCAD",bzj:0.32,profit:0.0014},{id:5,title:"EURJPY",bzj:0.52,profit:0.147}]
    }
  },
  methods:{
    changeproduct(e){
